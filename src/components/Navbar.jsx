            ...
            <div className='flex justify-between items-center m-4'>
                ...
                <div className="lg:hidden flex items-center">
                    <button onClick={toggleNavbar}>
                        {isMobileMenuOpen ? (
                            <i className="ri-close-line text-2xl"></i> // Close icon when menu is open
                        ) : (
                            <i className="ri-menu-3-line text-2xl"></i> // Menu icon when menu is closed
                        )}
                    </button>
                </div>
            </div>

            {/* Mobile Menu (Conditional rendering when isMobileMenuOpen is true) */}
            {isMobileMenuOpen && (
                <div className="fixed right-0 z-20 bg-neutral-900 w-full p-12 flex flex-col justify-center items-center lg:hidden">
                    ...
                    <div className="flex flex-col space-y-4 mt-6">
                        <a href="#" className="py-2 px-3 border rounded-md text-white border-white hover:bg-white hover:text-black">
                            {/* Sign In */}
                            <i className="ri-search-2-line"></i>
                        </a>
